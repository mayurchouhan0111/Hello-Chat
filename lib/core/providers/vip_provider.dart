...
class VIPService {
  ...
  Future<void> feedSampleTiers() async {
    final tiers = [
      ...
      { 'tierId': 'vip7', 'name': 'SVIP', 'level': 7, 'monthlyPriceInDiamonds': 200000000, 'monthlyPriceInUSD': 2000.0, 'benefits': ["all_access", "master_badge", "world_announce"], 'profileFrame': "https://picsum.photos/206", 'entryAnimation': "svip_entry", 'badgeIcon': "https://picsum.photos/107", 'backgroundImage': '', 'themeColor': '#FFFFFF', 'entryRequirement': 'Purchase 200,000,000 Diamonds', 'priorityMicAccess': true, 'isActive': true, 'sortOrder': 7 },
    ];
