...
class UserModel {
  ...
  final int dailyDiamondsSent;
  final int weeklyDiamondsSent;
  final int monthlyDiamondsSent;
  final int totalDiamondsSent;
  final int dailyBeansReceived;
  final int weeklyBeansReceived;
  final int monthlyBeansReceived;
  final int totalBeansReceived;
  final int level;
...
UserModel({
    ...
    this.dailyDiamondsSent = 0,
    this.weeklyDiamondsSent = 0,
    this.monthlyDiamondsSent = 0,
    this.totalDiamondsSent = 0,
    this.dailyBeansReceived = 0,
    this.weeklyBeansReceived = 0,
    this.monthlyBeansReceived = 0,
...
this.verificationStatus = 'unverified',
  ...
  factory UserModel.fromMap(Map<String, dynamic> data) {
    return UserModel(
      ...
      diamondBalance: (data['diamondBalance'] as num? ?? data['diamonds'] as num? ?? 0).toInt(),
      diamondStock: (data['diamondStock'] as num? ?? 0).toInt(),
      beansBalance: (data['beansBalance'] as num? ?? data['beans'] as num? ?? 0).toInt(),
      ...
      dailyDiamondsSent: (data['dailyDiamondsSent'] as num? ?? 0).toInt(),
      weeklyDiamondsSent: (data['weeklyDiamondsSent'] as num? ?? 0).toInt(),
      monthlyDiamondsSent: (data['monthlyDiamondsSent'] as num? ?? 0).toInt(),
      totalDiamondsSent: (data['totalDiamondsSent'] as num? ?? (data['totalDiamondsSpent'] as num? ?? 0)).toInt(),
      dailyBeansReceived: (data['dailyBeansReceived'] as num? ?? 0).toInt(),
      weeklyBeansReceived: (data['weeklyBeansReceived'] as num? ?? 0).toInt(),
      monthlyBeansReceived: (data['monthlyBeansReceived'] as num? ?? 0).toInt(),
      totalBeansReceived: (data['totalBeansReceived'] as num? ?? (data['beansBalance'] as num? ?? 0)).toInt(),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'dailyBeansReceived': dailyBeansReceived,
      'weeklyBeansReceived': weeklyBeansReceived,
      'monthlyBeansReceived': monthlyBeansReceived,
  ...
  UserModel copyWith({
    ...
    int? weeklyPrinceXP,
    int? monthlyPrinceXP,
    int? dailyDiamondsSent,
    int? weeklyDiamondsSent,
    int? monthlyDiamondsSent,
    int? totalDiamondsSent,
    int? dailyBeansReceived,
    int? weeklyBeansReceived,
    int? monthlyBeansReceived,
    ...
    return UserModel(
      ...
      dailyBeansReceived: dailyBeansReceived ?? this.dailyBeansReceived,
      weeklyBeansReceived: weeklyBeansReceived ?? this.weeklyBeansReceived,
      monthlyBeansReceived: monthlyBeansReceived ?? this.monthlyBeansReceived,
