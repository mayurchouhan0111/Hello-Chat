...
class _ProfileSetupScreenState extends ConsumerState<ProfileSetupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Listen for profile changes to set the ID automatically if it's generated by cloud function
    ref.listen(currentUserProfileProvider, (previous, next) {
      next.whenData((profile) {
        if (profile != null && _usernameController.text != profile.displayId) {
          setState(() {
            _usernameController.text = profile.displayId;
          });
        }
      });
    });
          ...
          child: Column(
            ...
            children: [
              ...
              AppTextField(
                ...
                label: "Hello ID",
                readOnly: true,
                hintText: "Waiting for system ID...",
              ),
              const SizedBox(height: 16),
