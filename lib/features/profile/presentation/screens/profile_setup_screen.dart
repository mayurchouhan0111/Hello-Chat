...
class _ProfileSetupScreenState extends ConsumerState<ProfileSetupScreen> {
  ...
  Future<void> _setupProfile() async {
    ...
    if (name.isEmpty || username.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Please fill in name and username")),
      );
      return;
    }
    ...
    try {
      ...
      await ref.read(profileServiceProvider).setupUserProfile(
        ...
        displayName: name,
        bio: bio,
        country: "IN", // Multi-country logic can be added later
          ...
          child: Column(
            ...
            children: [
              ...
              AppTextField(
                ...
                hintText: "e.g. star_voice_101",
                prefixIcon: const Icon(Icons.alternate_email_rounded, size: 20, color: AppColors.textTertiary),
              ),
              const SizedBox(height: 16),
