    ...
    <div className="space-y-10 animate-fade-in text-white pb-20">
        <div>
           <h1 className="text-4xl font-black text-white tracking-tighter uppercase flex items-center gap-4">
              <div className="p-3 bg-[#B4E0A2]/20 rounded-2xl border border-[#B4E0A2]/30"><Gamepad2 className="text-[#B4E0A2]" size={28} /></div>
              Mini Games
           </h1>
           <p className="text-slate-500 font-bold text-xs uppercase tracking-[0.3em] mt-3">Gaming Hub • Interactive Management</p>
        </div>
        <div className="flex bg-black/50 p-1.5 rounded-2xl border border-white/5 shadow-2xl">
      ...
      <AnimatePresence mode="wait">
        {activeTab === 'lucky_spin' ? (
          <motion.div key="spin" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="grid grid-cols-1 xl:grid-cols-3 gap-10">
            <div className="xl:col-span-1 space-y-10">
               <div className="grid grid-cols-2 gap-4">
                  <div className="card-glass p-6 bg-[#18181B]/40">
                  ...
                  <div className="card-glass p-6 bg-[#18181B]/40 border-emerald-500/10">
               ...
               {/* Top Scorers Section */}
               <div className="card-glass p-8 bg-[#18181B]/60 border-[#B4E0A2]/10">
               ...
               <div className="card-glass p-10 bg-[#18181B]/60 border-[#B4E0A2]/20 shadow-2xl">
                  <div className="flex items-center justify-between mb-10">
                     <h3 className="text-lg font-black uppercase tracking-tight flex items-center gap-3"><Activity size={20} className="text-[#B4E0A2]" />Operation Mode</h3>
                  ...
                  <div className="space-y-8">
                     ...
                     <button onClick={handleSaveSpin} className="w-full py-4 bg-[#B4E0A2] text-black hover:bg-[#8DBB7E] transition-all rounded-[32px] font-black uppercase text-xs tracking-widest shadow-xl flex items-center justify-center gap-3 mt-6 shadow-[#B4E0A2]/20"><Save size={16} /> Deploy Config</button>
                  </div>
               </div>
            </div>
            ...
            <div className="xl:col-span-2 space-y-6">
               ...
               <div className="card-glass p-8 bg-[#B4E0A2]/5 border-[#B4E0A2]/10">
                  <h5 className="text-[10px] font-black text-[#B4E0A2] uppercase tracking-[0.3em] mb-4 flex items-center gap-2"><AlertCircle size={14} /> Platform Intelligence</h5>
          ...
          <motion.div key="draw" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="grid grid-cols-1 lg:grid-cols-2 gap-10">
             <div className="card-glass p-10 bg-[#18181B]/60 shadow-2xl space-y-10">
                ...
                <div className="space-y-8">
                   <div className="grid grid-cols-2 gap-8">
                       <div className="space-y-4"><label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Base Prize Pool</label>
                         <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                               <Coins className="text-amber-400 group-focus-within:text-[#B4E0A2] transition-colors" size={18} />
                            </div>
                    ...
                    <button onClick={handleSaveDraw} className="w-full py-5 bg-[#B4E0A2] text-black hover:bg-[#8DBB7E] rounded-[32px] font-black text-sm uppercase tracking-[0.2em] shadow-2xl shadow-[#B4E0A2]/20 flex items-center justify-center gap-3"><Save size={18} /> Update Lottery System</button>
                </div>
             </div>
             <div className="space-y-10"><div className="card-glass p-10 bg-black/30 border-amber-500/20"><h4 className="text-sm font-black uppercase text-amber-400 mb-6 flex items-center gap-2"><RefreshCw size={18} /> Super Admin Control</h4><p className="text-xs text-slate-500 font-bold mb-8 italic">Trigger an immediate lottery draw and generate results right now.</p><button className="w-full py-4 bg-amber-500 hover:bg-amber-600 text-black rounded-xl font-black uppercase text-xs tracking-widest transition-all">Manual Draw Trigger</button></div></div>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
